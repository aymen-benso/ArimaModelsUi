...
const ChartComponent = () => {
  ...
  useEffect(() => {
    fetch(`http://localhost:8000/consumption/Residentiel_GAZEUX.csv/${year}`)
  ...
  useEffect(() => {
    fetch(`http://localhost:8000/consumption/Residentiel_ELECTRICITE.csv/${year}`)
      .then(response => response.json())
      .then(data => {
  ...
  useEffect(() => {
    fetch(`http://localhost:8000/consumption/Residentiel_ Liquide.csv/${year}`)
      .then(response => response.json())
      .then(data => {
