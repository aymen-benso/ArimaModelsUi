...
const ChartComponent = () => {
  ...
  useEffect(() => {
    fetch(`http://localhost:8000/consumption/Transport_GAZEUX.csv/${year}`)
  ...
  useEffect(() => {
    fetch(`http://localhost:8000/consumption/Transport_ELECTRICITE.csv/${year}`)
      .then(response => response.json())
      .then(data => {
  ...
  useEffect(() => {
    fetch(`http://localhost:8000/consumption/Transport_Liquides.csv/${year}`)
      .then(response => response.json())
      .then(data => {
